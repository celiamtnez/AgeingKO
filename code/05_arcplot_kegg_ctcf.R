...
# certain signalling pathways in old and young CTCF KO mice
...
co_corr_young <- fromJSON(file = '~/Documents/Collaborations/Martinez_HPC/tables/221111_co_expression_CTCF KO_young.json')

mean_expr_young <- read.table(file = "~/Documents/Collaborations/Martinez_HPC/tables/221111_mean_expression_hep_CTCF KO_young.csv", 
                              header = TRUE, sep=','
)
...
# read result files from python.
co_corr_old <- fromJSON(file = '~/Documents/Collaborations/Martinez_HPC/tables/221111_co_expression_CTCF KO_old.json')

mean_expr_old <- read.table(file = "~/Documents/Collaborations/Martinez_HPC/tables/221111_mean_expression_hep_CTCF KO_old.csv", 
                              header = TRUE, sep=','
)
