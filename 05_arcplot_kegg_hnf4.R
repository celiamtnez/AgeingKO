...
# certain signalling pathways in old and young HNF4 KO mice
...
co_corr_young <- fromJSON(file = '~/Documents/Collaborations/Martinez_HPC/tables/221111_co_expression_HNF4 KO_young.json')

mean_expr_young <- read.table(file = "~/Documents/Collaborations/Martinez_HPC/tables/221111_mean_expression_hep_HNF4 KO_young.csv", 
                              header = TRUE, sep=','
)
...
for (idx in 1:length(co_corr_young)){
  ...
  #      edge_list_coex <- rbind(edge_list_coex, tmp_id)
  #      edge_weights_coex <- rbind(edge_weights_coex, co_corr_young[idx][names_coex])
  #    }
  #  }
...
#pathway_groups <- pathway_groups[pathway_groups$genes %in% mean_expr_young$X,]
...
# read result files from python.
co_corr_old <- fromJSON(file = '~/Documents/Collaborations/Martinez_HPC/tables/221111_co_expression_HNF4 KO_old.json')

mean_expr_old <- read.table(file = "~/Documents/Collaborations/Martinez_HPC/tables/221111_mean_expression_hep_HNF4 KO_old.csv", 
                              header = TRUE, sep=','
)
